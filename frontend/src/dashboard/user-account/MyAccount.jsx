                ...
                {!loading && !error && <div className="grid md:grid-cols-3 gap-10">
                    ...
                    <div className="md:col-span-2 md:px-[30px]">
                        <div className='flex items-center'>
                            ...
                            <button onClick={() => setTab('settings')} className={` ${tab === 'settings' && 'bg-primaryColor text-white font-normal'} py-2 mr-5 px-5 rounded-md text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}>Profile</button>

                            <button onClick={() => setTab('notifications')} className={` ${tab === 'notifications' && 'bg-primaryColor text-white font-normal'} py-2 mr-5 px-5 rounded-md inline-flex items-center justify-center text-headingColor font-semibold text-[16px] leading-7 border border-solid border-primaryColor`}>
                                <IoIosNotifications className='h-5 w-5 mr-2' />
                                Notifications
                            </button>
                        ...
                        {
                            tab == 'notifications' && <Notifications user={userData} />
                        }
